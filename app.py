...
external_stylesheets = ['01_first.css','https://codepen.io/chriddyp/pen/bWLwgP.css']
...
app.layout = html.Div([
    ...
    html.H1(children='BrainoCare', style={'textAlign': 'center','color':'#faa675'}),
    ...
    html.Div(id='prediction', style={'position':'absolute', 'left':'800px', 'top':'310px', 'font-size':'x-large','color':'white'}),
    html.Div(id='prediction2', style={'position':'absolute', 'left':'800px', 'top':'400px', 'font-size': 'x-large','color':'white'}),
    
    html.Div(id='facts', style={'position':'absolute', 'left':'800px', 'top':'465px', 'font-size': 'large',\
                               'height': '200px', 'width': '500px','color':'white'}),
